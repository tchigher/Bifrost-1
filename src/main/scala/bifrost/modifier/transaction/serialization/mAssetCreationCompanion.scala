...
import bifrost.modifier.transaction.bifrostTransaction.{AssetCreation, mAssetCreation}
...
object mAssetCreationCompanion extends Serializer[mAssetCreation] {
  override def toBytes(ac: mAssetCreation): Array[Byte] = {
  ...
  override def parseBytes(bytes: Array[Byte]): Try[mAssetCreation] = Try {
